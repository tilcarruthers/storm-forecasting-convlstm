...
def main() -> None:
    ...
    validation = validate_index_against_h5(df_index, data_cfg["h5_path"], event_col=data_cfg["event_col"])
    ...
    metrics_path = ensure_dir(outputs_cfg["metrics_dir"]) / f"{outputs_cfg['run_name']}.json"
